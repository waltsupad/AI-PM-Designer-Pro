# AI Product Marketing Designer PRO v3.0
...
### 5. v3.0 新增功能 ✨
*   **一鍵下載所有圖檔**: 批次下載功能，支援 ZIP 打包，採用英文關鍵字命名規則，方便後續使用與整理。
*   **顏色參考優化**: 自動提取參考圖片的主色調，應用於圖片生成，確保視覺一致性。
*   **語言模式切換**: 支援繁體中文/英文模式（英文模式開發中），自動識別品牌中的英文元素並保留。
*   **智能圖片命名**: 自動生成易於識別的檔名格式 `{type}_{ratio}_{index}_{keyword}.png`，方便網頁建置自動化程序識別。
...
*   ✨ **顏色參考優化**: 自動提取參考圖片的主色調，應用於圖片生成
*   ✨ **語言模式切換**: 支援繁體中文/英文模式（英文模式開發中）
*   ✨ **智能圖片命名**: 自動生成易於識別的檔名格式

### v2.9 (2025)
*   **專業工作流**: 審閱與製作模式、精細化控圖、一鍵量產
*   **系統提示詞優化**: 差異化標準、品質保證、敘事連貫性、視覺一致性
*   **比例選擇功能**: 支援多種圖片比例（3:4、4:3、9:16、16:9）
*   **圖片放大檢視**: 所有生成的圖片都支援放大檢視功能
